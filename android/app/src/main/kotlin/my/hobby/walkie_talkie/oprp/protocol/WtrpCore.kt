...
object WtrpConstants {
    ...
    const val CAT_USB_HID: Byte = 0x04
    const val CAT_BT_REMOTE: Byte = 0x05
    const val CAT_COMPANION_APP: Byte = 0x06
    const val CAT_CUSTOM: Byte = 0xFF.toByte()
    
    // Manufacturer IDs
    const val MAN_REFERENCE: Short = 0x0001
    const val MAN_WALKIETALKIE: Short = 0x0002
    const val MAN_GENERIC: Short = 0xFFFF.toShort()
}
 ...
 * Layout: [Version][DeviceID][Command][SessionID][SeqNum][Len][Payload...][CRC8]
 */
data class WtrpPacket(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is WtrpPacket) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + sessionId.toInt()
